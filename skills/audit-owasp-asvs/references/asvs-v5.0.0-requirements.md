# OWASP ASVS 5.0.0 - Requirements Reference (Machine-Readable)

Generated from the official OWASP ASVS v5.0.0 CSV distribution.
Source: https://github.com/OWASP/ASVS/tree/v5.0.0
License: CC BY-SA 4.0 (https://creativecommons.org/licenses/by-sa/4.0/)

Use this reference to map evidence collected during an audit to exact requirement IDs.
Requirement IDs are prefixed with the ASVS version when cited in reports, e.g. `v5.0.0-6.2.1`.

Levels: L1 = Level 1 (opportunistic attacks), L2 = Level 2 (sophisticated attacks, current best practice), L3 = Level 3 (advanced / high-value targets).

## Chapters overview

| ID | Chapter | Requirements | Levels |
|----|---------|--------------|--------|
| V1 | Encoding and Sanitization | 30 | L1, L2, L3 |
| V2 | Validation and Business Logic | 13 | L1, L2, L3 |
| V3 | Web Frontend Security | 31 | L1, L2, L3 |
| V4 | API and Web Service | 16 | L1, L2, L3 |
| V5 | File Handling | 13 | L1, L2, L3 |
| V6 | Authentication | 47 | L1, L2, L3 |
| V7 | Session Management | 19 | L1, L2, L3 |
| V8 | Authorization | 13 | L1, L2, L3 |
| V9 | Self-contained Tokens | 7 | L1, L2 |
| V10 | OAuth and OIDC | 36 | L1, L2, L3 |
| V11 | Cryptography | 24 | L1, L2, L3 |
| V12 | Secure Communication | 12 | L1, L2, L3 |
| V13 | Configuration | 21 | L1, L2, L3 |
| V14 | Data Protection | 13 | L1, L2, L3 |
| V15 | Secure Coding and Architecture | 21 | L1, L2, L3 |
| V16 | Security Logging and Error Handling | 17 | L2, L3 |
| V17 | WebRTC | 12 | L2, L3 |
| | **Total** | **345** | |

## V1 Encoding and Sanitization

### V1.1 Encoding and Sanitization Architecture (levels: L2)
...
### V1.2 Injection Prevention (levels: L1, L2, L3)
...
### V1.3 Sanitization (levels: L1, L2, L3)
...
### V1.4 Memory, String, and Unmanaged Code (levels: L2)
...
### V1.5 Safe Deserialization (levels: L1, L2, L3)
...
### V2.1 Validation and Business Logic Documentation (levels: L1, L2)
...
### V2.2 Input Validation (levels: L1, L2)
...
### V2.3 Business Logic Security (levels: L1, L2, L3)
...
### V2.4 Anti-automation (levels: L2, L3)
...
### V3.1 Web Frontend Security Documentation (levels: L3)
...
### V3.2 Unintended Content Interpretation (levels: L1, L3)
...
### V3.3 Cookie Setup (levels: L1, L2, L3)
...
### V3.4 Browser Security Mechanism Headers (levels: L1, L2, L3)
...
### V3.5 Browser Origin Separation (levels: L1, L2, L3)
...
### V3.6 External Resource Integrity (levels: L3)
...
### V3.7 Other Browser Security Considerations (levels: L2, L3)
...
### V4.1 Generic Web Service Security (levels: L1, L2, L3)
...
### V4.2 HTTP Message Structure Validation (levels: L2, L3)
...
### V5.1 File Handling Documentation (levels: L2)
...
### V5.2 File Upload and Content (levels: L1, L2, L3)
...
### V5.3 File Storage (levels: L1, L3)
...
### V6.1 Authentication Documentation (levels: L1, L2)
...
### V6.2 Password Security (levels: L1, L2)
...
### V6.3 General Authentication Security (levels: L1, L2, L3)
...
### V6.4 Authentication Factor Lifecycle and Recovery (levels: L1, L2, L3)
...
### V6.5 General Multi-factor authentication requirements (levels: L2, L3)
...
### V6.6 Out-of-Band authentication mechanisms (levels: L2, L3)
...
### V6.7 Cryptographic authentication mechanism (levels: L3)
...
### V6.8 Authentication with an Identity Provider (levels: L2)
...
### V7.1 Session Management Documentation (levels: L2)
...
### V7.2 Fundamental Session Management Security (levels: L1)
...
### V7.3 Session Timeout (levels: L2)
...
### V7.4 Session Termination (levels: L1, L2)
...
### V7.5 Defenses Against Session Abuse (levels: L2, L3)
...
### V7.6 Federated Re-authentication (levels: L2)
...
### V8.1 Authorization Documentation (levels: L1, L2, L3)
...
### V8.2 General Authorization Design (levels: L1, L2, L3)
...
### V8.3 Operation Level Authorization (levels: L1, L3)
...
### V8.4 Other Authorization Considerations (levels: L2, L3)
...
### V9.1 Token source and integrity (levels: L1)
...
### V9.2 Token content (levels: L1, L2)
...
### V10.1 Generic OAuth and OIDC Security (levels: L2)
...
### V10.2 OAuth Client (levels: L2, L3)
...
### V10.3 OAuth Resource Server (levels: L2, L3)
...
### V10.4 OAuth Authorization Server (levels: L1, L2, L3)
...
### V10.6 OpenID Provider (levels: L2)
...
### V10.7 Consent Management (levels: L2)
...
### V11.1 Cryptographic Inventory and Documentation (levels: L2, L3)
...
### V11.2 Secure Cryptography Implementation (levels: L2, L3)
...
### V11.3 Encryption Algorithms (levels: L1, L2, L3)
...
### V11.4 Hashing and Hash-based Functions (levels: L1, L2)
...
### V11.5 Random Values (levels: L2, L3)
...
### V11.6 Public Key Cryptography (levels: L2, L3)
...
### V11.7 In-Use Data Cryptography (levels: L3)
...
### V12.1 General TLS Security Guidance (levels: L1, L2, L3)
...
### V12.2 HTTPS Communication with External Facing Services (levels: L1)
...
### V12.3 General Service to Service Communication Security (levels: L2, L3)
...
### V13.1 Configuration Documentation (levels: L2, L3)
...
### V13.2 Backend Communication Configuration (levels: L2, L3)
...
### V13.3 Secret Management (levels: L2, L3)
...
### V13.4 Unintended Information Leakage (levels: L1, L2, L3)
...
### V14.1 Data Protection Documentation (levels: L2)
...
### V14.2 General Data Protection (levels: L1, L2, L3)
...
### V14.3 Client-side Data Protection (levels: L1, L2)
...
### V15.1 Secure Coding and Architecture Documentation (levels: L1, L2, L3)
...
### V15.2 Security Architecture and Dependencies (levels: L1, L2, L3)
...
### V15.3 Defensive Coding (levels: L1, L2)
...
### V15.4 Safe Concurrency (levels: L3)
...
### V16.1 Security Logging Documentation (levels: L2)
...
### V16.2 General Logging (levels: L2)
...
### V16.3 Security Events (levels: L2)
...
### V16.4 Log Protection (levels: L2)
...
### V16.5 Error Handling (levels: L2, L3)
...
### V17.1 TURN Server (levels: L2, L3)
